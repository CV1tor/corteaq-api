...
public class User implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        if (this.userType.equals(UserType.ADMIN)) {
            return List.of(new SimpleGrantedAuthority("ROLE_ADMIN"), new SimpleGrantedAuthority("ROLE_BARBER"), new SimpleGrantedAuthority("ROLE_CUSTOMER"));
        } else if (this.userType.equals(UserType.BARBER)) {
            return List.of(new SimpleGrantedAuthority("ROLE_BARBER"), new SimpleGrantedAuthority("ROLE_USER"));
        } else if (this.userType.equals(UserType.CUSTOMER)) {
